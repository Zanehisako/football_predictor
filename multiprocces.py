...
async def page.select(page, selector, attribute='text', timeout=2):
...
async def get_page_content(url, page):
    ...
    for attempt in range(1, max_retries + 1):
        try:
            ...
            # Managers
            h_mgr_full = await page.select(page, "#content > div.scorebox > div:nth-child(1) > div:nth-child(5)", 'text_all')
            a_mgr_full = await page.select(page, "#content > div.scorebox > div:nth-child(2) > div:nth-child(5)", 'text_all')
            ...
            # Captains
            home_team_captain = await page.select(page, "#content > div.scorebox > div:nth-child(1) > div:nth-child(6) > a")
            away_team_captain = await page.select(page, "#content > div.scorebox > div:nth-child(2) > div:nth-child(6) > a")
            ...
            # --- TEAM STATS TABLE ---
            home_team_possession = await page.select(page, "#team_stats > table > tbody > tr:nth-child(3) > td:nth-child(1) > div > div:nth-child(1) > strong")
            away_team_possession = await page.select(page, "#team_stats > table > tbody > tr:nth-child(3) > td:nth-child(2) > div > div:nth-child(1) > strong")

            home_team_pass_accuracy = await page.select(page, "#team_stats > table > tbody > tr:nth-child(5) > td:nth-child(1) > div > div:nth-child(1) > strong")
            away_team_pass_accuracy = await page.select(page, "#team_stats > table > tbody > tr:nth-child(5) > td:nth-child(2) > div > div:nth-child(1) > strong")

            home_team_shot_accuracy = await page.select(page, "#team_stats > table > tbody > tr:nth-child(7) > td:nth-child(1) > div > div:nth-child(1) > strong")
            away_team_shot_accuracy = await page.select(page, "#team_stats > table > tbody > tr:nth-child(7) > td:nth-child(2) > div > div:nth-child(1) > strong")

            home_team_save_accuracy = await page.select(page, "#team_stats > table > tbody > tr:nth-child(9) > td:nth-child(1) > div > div:nth-child(1) > strong")
            away_team_save_accuracy = await page.select(page, "#team_stats > table > tbody > tr:nth-child(9) > td:nth-child(2) > div > div:nth-child(1) > strong")

            home_team_cards_number = await page.select(page, "#team_stats > table > tbody > tr:nth-child(11) > td:nth-child(1) > div > div > div", 'child_count')
            away_team_cards_number = await page.select(page, "#team_stats > table > tbody > tr:nth-child(11) > td:nth-child(2) > div > div > div", 'child_count')

            # --- EXTRA STATS (Fouls, Corners, etc) ---
            home_team_fouls = await page.select(page, "#team_stats_extra > div:nth-child(1) > div:nth-child(4)")
            away_team_fouls = await page.select(page, "#team_stats_extra > div:nth-child(1) > div:nth-child(6)")

            home_team_corners = await page.select(page, "#team_stats_extra > div:nth-child(1) > div:nth-child(7)")
            away_team_corners = await page.select(page, "#team_stats_extra > div:nth-child(1) > div:nth-child(9)")

            home_team_crosses = await page.select(page, "#team_stats_extra > div:nth-child(1) > div:nth-child(10)")
            away_team_crosses = await page.select(page, "#team_stats_extra > div:nth-child(1) > div:nth-child(12)")

            home_team_touches = await page.select(page, "#team_stats_extra > div:nth-child(1) > div:nth-child(13)")
            away_team_touches = await page.select(page, "#team_stats_extra > div:nth-child(1) > div:nth-child(15)")

            home_team_tackels = await page.select(page, "#team_stats_extra > div:nth-child(2) > div:nth-child(4)")
            away_team_tackels = await page.select(page, "#team_stats_extra > div:nth-child(2) > div:nth-child(6)")

            home_team_interceptions = await page.select(page, "#team_stats_extra > div:nth-child(2) > div:nth-child(7)")
            away_team_interceptions = await page.select(page, "#team_stats_extra > div:nth-child(2) > div:nth-child(9)")

            home_team_aerials = await page.select(page, "#team_stats_extra > div:nth-child(2) > div:nth-child(10)")
            away_team_aerials = await page.select(page, "#team_stats_extra > div:nth-child(2) > div:nth-child(12)")

            home_team_clearances = await page.select(page, "#team_stats_extra > div:nth-child(2) > div:nth-child(13)")
            away_team_clearances = await page.select(page, "#team_stats_extra > div:nth-child(2) > div:nth-child(15)")

            home_team_offsides = await page.select(page, "#team_stats_extra > div:nth-child(3) > div:nth-child(4)")
            away_team_offsides = await page.select(page, "#team_stats_extra > div:nth-child(3) > div:nth-child(6)")

            home_team_goal_kicks = await page.select(page, "#team_stats_extra > div:nth-child(3) > div:nth-child(7)")
            away_team_goal_kicks = await page.select(page, "#team_stats_extra > div:nth-child(3) > div:nth-child(9)")

            home_team_throw_ins = await page.select(page, "#team_stats_extra > div:nth-child(3) > div:nth-child(10)")
            away_team_throw_ins = await page.select(page, "#team_stats_extra > div:nth-child(3) > div:nth-child(12)")

            home_team_long_balls = await page.select(page, "#team_stats_extra > div:nth-child(3) > div:nth-child(13)")
            away_team_long_balls = await page.select(page, "#team_stats_extra > div:nth-child(3) > div:nth-child(15)")
